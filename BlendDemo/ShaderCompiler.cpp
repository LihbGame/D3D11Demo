...
void ShaderCompiler::Compiler(std::wstring filename, std::string EntryPoint, std::string Target)
{
	...
	//compiler  shader
	hr = D3DCompileFromFile(L"VertexShader.hlsl", nullptr, nullptr,"VS", "vs_5_0",NULL, NULL, &pBlob, &pErrorBlob);
...
void Shader::InitAll()
{
	...
	VSTexShader->Compiler(L"Default.hlsl", "VS", "vs_5_0");
	PSTexShader->Compiler(L"FX\\Basic.hlsl", "PS", "ps_5_0");
}
